...
public class PumpFragment extends Fragment {
    ...
    public static PumpFragment newInstance(String deviceType, String deviceId) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvWaterLevelValue = view.findViewById(R.id.tv_water_level_value);
        sPump = view.findViewById(R.id.switch_pump);
        ...
        // bat/tat may bom
        sPump.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
        ...
        try {
            ...
            connectToken.setActionCallback(new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    String payload = "{\"pump\": \"Get status\"}";
                ...
                if (topic.equals(subscribeTopic1)) {
                    try {
                        ...
                        try {
                            JSONObject payload = new JSONObject(message.toString());
                            JSONObject data = payload.getJSONObject("d");
                            waterLevelValue = data.getDouble("water_level");
                            tvWaterLevelValue.setText(String.format("%.1f", waterLevelValue) + " cm");
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
